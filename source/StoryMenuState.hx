...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		sprDifficulty = new FlxSprite(leftArrow.x + 1, leftArrow.y);
		...
		rightArrow.animation.addByPrefix('press', "arrow right", 24, false);
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		switch (curDifficulty)
		{
			...
			case 2:
				...
				sprDifficulty.offset.x = 68;
			case 3:
				sprDifficulty.animation.play('hard plus');
